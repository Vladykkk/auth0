        ...
        <div className="App">
            ...
            <div className="main-content">
                ...
                <p className="main-paragraph">
                    Welcome to our platform where people come together
                    together to give or receive help. Regardless of whether
                    are you looking for professional services or help with everyday needs,
